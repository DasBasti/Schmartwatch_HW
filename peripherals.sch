...
F 4 "2,17" H 1850 550 50  0001 C CNN "Price"
F 5 "LSM303AGR" H 1850 550 50  0001 C CNN "MPN"
	1    9000 2700
	1    0    0    -1  
$EndComp
$Comp
...
F 2 "Capacitor_SMD:C_0402_1005Metric" H 9388 1600 50  0001 C CNN
F 3 "https://www.mouser.de/datasheet/2/212/KEM_C1006_X5R_SMD-1103249.pdf" H 9350 1750 50  0001 C CNN
F 4 "0,451" H 1850 550 50  0001 C CNN "Price"
F 5 "C0402C106M7PACTU" H 1850 550 50  0001 C CNN "MPN"
	1    9350 1750
	-1   0    0    -1  
$EndComp
$Comp
...
F 2 "Capacitor_SMD:C_0402_1005Metric" H 8438 1600 50  0001 C CNN
F 3 "https://www.mouser.de/datasheet/2/212/KEM_C1006_X5R_SMD-1103249.pdf" H 8400 1750 50  0001 C CNN
F 4 "0,451" H 1800 550 50  0001 C CNN "Price"
F 5 "C0402C106M7PACTU" H 1800 550 50  0001 C CNN "MPN"
	1    8400 1750
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
F 2 "Capacitor_SMD:C_0402_1005Metric" H 9738 3000 50  0001 C CNN
F 3 "https://www.mouser.de/datasheet/2/396/mlcc02_e-1307760.pdf" H 9700 3150 50  0001 C CNN
F 4 "0,394" H 1850 550 50  0001 C CNN "Price"
F 5 "JMK105BJ224MH-R" H 1850 550 50  0001 C CNN "MPN"
	1    9700 3150
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
F 3 "https://www.mouser.de/datasheet/2/427/crcwce3-1223726.pdf" H 7500 2250 50  0001 C CNN
F 4 "0,082" H 4700 -550 50  0001 C CNN "Price"
F 5 "CRCW040210K0FKEDC" H 4700 -550 50  0001 C CNN "MPN"
	1    7500 2250
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5B3B3966
P 7950 2250
F 0 "R15" H 8020 2296 50  0000 L CNN
F 1 "10k" H 8020 2205 50  0000 L CNN
F 2 "Resistor_SMD:R_0402_1005Metric" V 7880 2250 50  0001 C CNN
F 3 "https://www.mouser.de/datasheet/2/427/crcwce3-1223726.pdf" H 7950 2250 50  0001 C CNN
F 4 "0,082" H 4850 -550 50  0001 C CNN "Price"
F 5 "CRCW040210K0FKEDC" H 4850 -550 50  0001 C CNN "MPN"
	1    7950 2250
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5B3B396D
P 7500 2000
F 0 "#PWR034" H 7500 1850 50  0001 C CNN
...
F 4 "M41T62LC6F" H -1950 -300 50  0001 C CNN "MPN"
F 5 "3,10" H -1950 -300 50  0001 C CNN "Price"
	1    3000 2350
	1    0    0    -1  
$EndComp
...
F 4 "0,082" H -650 -750 50  0001 C CNN "Price"
F 5 "CRCW040210K0FKEDC" H -650 -750 50  0001 C CNN "MPN"
	1    2150 2050
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "0,082" H -1400 -750 50  0001 C CNN "Price"
F 5 "CRCW040210K0FKEDC" H -1400 -750 50  0001 C CNN "MPN"
	1    1700 2050
	1    0    0    -1  
$EndComp
$Comp
...
F 2 "Resistor_SMD:R_0402_1005Metric" V 3430 2050 50  0001 C CNN
F 3 "https://www.mouser.de/datasheet/2/427/crcwce3-1223726.pdf" H 3500 2050 50  0001 C CNN
F 4 "0,082" H 400 -750 50  0001 C CNN "Price"
F 5 "CRCW040210K0FKEDC" H 400 -750 50  0001 C CNN "MPN"
	1    3500 2050
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 4 "0,139" H -2550 -650 50  0001 C CNN "Price"
F 5 "GRM152R60J104ME19D" H -2550 -650 50  0001 C CNN "MPN"
	1    2550 2650
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 4 "SI1308EDL-T1-GE3" H -6500 3450 50  0001 C CNN "MPN"
F 5 "0,402" H -6500 3450 50  0001 C CNN "Price"
	1    3050 5950
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 2 "Resistor_SMD:R_0402_1005Metric" V 2530 5950 50  0001 C CNN
F 3 "https://www.mouser.de/datasheet/2/427/crcwce3-1223726.pdf" H 2600 5950 50  0001 C CNN
F 4 "0,082" H -200 3150 50  0001 C CNN "Price"
F 5 "CRCW040210K0FKEDC" H -200 3150 50  0001 C CNN "MPN"
	1    2600 5950
	0    1    1    0   
$EndComp
Wire Wire Line
...
F 4 "0,139" H 400 4400 50  0001 C CNN "Price"
F 5 "CKP1608D2R2M-T" H 400 4400 50  0001 C CNN "MPN"
	1    3150 5400
	1    0    0    -1  
$EndComp
$Comp
